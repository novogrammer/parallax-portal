...
export function calculatePortalGeometry(
  ...
  const referenceCameraDistance = calculateReferenceCameraDistance(profile, referenceProjectionHeightMeters)
  ...
  const derivedValues = [referenceCameraDistance, cameraY, renderCameraFovY]
